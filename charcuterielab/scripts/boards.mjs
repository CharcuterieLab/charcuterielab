...
export async function loadBoards(root) {
  ...
  const order = (b) => (b.book === "plant" ? 100 : 0) + Number(b.number.slice(3));
  return all
...
export function boardPage(h, b, { all, bySlug, notes, blogTitles }) {
  ...
  <div class="bl-inner">
    ...
    <section class="bl-section" aria-labelledby="bl-on">
      ...
      <p class="bl-note">Amounts and prices for each item are in the book, or open the board in the Board Builder for amounts sized to your guest count.</p>
    </section>
