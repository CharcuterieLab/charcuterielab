---
title: "Charcuterie Board Quantities: How Much to Buy"
date: "2026-08-26"
...
One standard box of crackers (approximately 200g) contains roughly 30–40 crackers depending on size. At 6–8 crackers per person for an appetizer, one box serves 4–6 people.

For two cracker types: one box of each serves 8–12 guests at appetizer ratio. For larger groups, scale accordingly and keep the ratio at roughly 50/50 between neutral and flavored options.

### Fruit

Fruit quantities are more forgiving because fruit is the most flexible element:

- 1 large bunch of grapes (about 1 lb) serves 6–8 guests as the primary fruit
- 2 apples or 2 pears (sliced) add secondary fruit for up to 12 guests
- Dried fruit (figs, apricots, dates) — a small bowl or pile is enough for any board size; a 200g package serves 12–16 people

For larger groups, add a second grape bunch and a second secondary fruit rather than scaling individual items.

### Condiments

Condiments are board-level quantities, not per-person:

- 1 small jar of honey (8–12 oz) serves any board size up to 30 guests
- 1 small jar of fig jam or quince paste (7–8 oz) serves up to 20 guests
- 1 small jar of grainy mustard (8 oz) serves any board size
...
**Underbuying cheese.** The most frequent mistake. Cheese is the most in-demand element on most boards and runs out first. Always buy more than you calculate. Leftover hard aged cheese keeps 3–4 weeks wrapped in parchment — it's never wasted.

**Underbuying crackers.** The second most frequent mistake. Crackers go faster than expected because each cheese-and-meat bite requires one. One box per 4–6 people is correct, not one box total for the whole board.
...
- [Grazing Board vs. Charcuterie Board](https://charcuterielab.com/blog/grazing-board-vs-charcuterie-board/)
