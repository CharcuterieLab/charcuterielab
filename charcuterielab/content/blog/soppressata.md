...
- **Stacked overlap:** Lay 5–7 slices slightly overlapping in a line or curve. Clean, graphic presentation.
- **Fanned or rolled:** Roll individual slices into loose cylinders or quarter-folds for height and texture variation.
- **Draped:** Let slices fall naturally over a small wedge of cheese or the edge of a ramekin. Works particularly well if the soppressata has natural casing with slight wrinkle.
...
- **Dried apricots** — the tartness and sweetness of dried apricot cuts directly through the fat and provides a clean, bright contrast to the spice. The best fruit pairing for hot soppressata.
- **Fresh or dried figs** — rich, concentrated sweetness that holds up to soppressata's intensity.
- **Honey** — specifically a robust amber or buckwheat honey. Light honey is overwhelmed by soppressata's saltiness and spice. Dark honey creates a proper contrast.
- **Calabrian chili jam** — if you want to lean into the heat rather than buffer it, a sweet-hot chili jam alongside hot soppressata is a bold, coherent pairing.

**Cheese pairings:**
- **Provolone** — the mild, slightly sharp Italian cheese is a natural companion. The fat in provolone buffers the heat; the cheese's mild saltiness doesn't compete.
- **Fresh mozzarella** — the high moisture content and milky neutrality provide a clean dairy contrast to soppressata's intensity.
- **Aged asiago or mild pecorino** — firmer, slightly nutty. Works for more robust board combinations.
- **Avoid:** very aged or very sharp cheeses alongside hot soppressata — two strong flavors competing produce fatigue rather than pleasure.

**Bread and cracker pairings:**
- **Ciabatta or focaccia** — the olive oil and open crumb of ciabatta provides a satisfying fat-on-fat combination with soppressata's marbled slices.
- **Breadsticks** — neutral, crunchy, classic Italian companion.
- **Crackers with herbs** — rosemary crackers echo the garlic-herb character of mild soppressata.

**Drink pairings:**
- **Barbera or Sangiovese** — high-acid Italian reds that cut through soppressata's fat beautifully. The fruity, savory character of these wines mirrors the meat's flavor profile.
- **Lambrusco** — sparkling red wine that pairs exceptionally well with all forms of cured Italian pork. The slight sweetness of many Lambrusco styles provides a version of the salt-sweet contrast in liquid form.
- **Craft lager or pilsner** — the clean, crisp, slightly bitter character of lager cuts fat and refreshes the palate between bites of spicy soppressata.
- **Aperol Spritz or Campari-based cocktails** — the bitter orange and herbaceous notes of Campari create a complex contrast with the fat and spice of hot soppressata.
...
|---|---|
| Meat | Coarsely ground pork (fat + lean) |
| Origin | Southern Italy (Calabria, Campania, Basilicata) |
| Texture | Firm, slightly chewy; visible fat distribution |
| Flavor | Garlic-forward, savory, spice-dependent; lactic acid tang |
| Varieties | Sweet/Mild; Hot/Calabrian-spiced; Sopressa Vicentina (PDO) |
| Best board role | Bold, assertive cured meat; flavor contrast anchor |
| Heat level | None (sweet) to medium-high (Calabrian hot) |
| Sweet pairing | Dried apricots, dark honey, fresh figs |
| Cheese pairing | Provolone, fresh mozzarella, mild asiago |
| Bread pairing | Ciabatta, breadsticks, herbed crackers |

---

## Quick Pairing Reference

| Board Type | Soppressata Pairing |
|---|---|
| Classic Italian board | Hot soppressata + provolone + dried apricots + ciabatta |
| Contrast/bold board | Hot soppressata + dark honey + fig jam + fresh mozzarella |
| Red wine board | Mild soppressata + asiago + Barbera + breadsticks |
| Heat-forward board | Hot soppressata + chili jam + aged pecorino + crackers |
| Beer board | Hot soppressata + fresh mozzarella + lager + dried figs |
